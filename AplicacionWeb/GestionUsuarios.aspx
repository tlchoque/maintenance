<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="GestionUsuarios.aspx.cs" Inherits="Mantenimiento.AplicacionWeb.GesionUsuarios" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="<%= Page.ResolveUrl("~/Scripts/GestionUsuarios.js") %>" type="text/javascript"></script>
...
<div id="toolbar-box">
        <div class="submenu-box">
            <div class="toolbar-list">
                <ul>
                    <li><a  href="UsuarioDatos.aspx?opc=nuevo"><span class="icon-new-16"></span>Nuevo</a></li>
            ...
            <!--fin toolbar-->
            <div class="pagetitle icon-gestion-user">
...
<table class="stabla " id="listUsuarios" width="100%">
            <thead>
                <tr >
                    <th width="3%">
                        <input type="checkbox" id="allchecked" onchange="MarcarCheckbox(this.id,'listUsuarios');" />
                    </th>
                    <th width="22%" >
                        Apellidos y Nombres
                    </th>
