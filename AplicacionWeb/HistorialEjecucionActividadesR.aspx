<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="HistorialEjecucionActividadesR.aspx.cs" Inherits="Mantenimiento.AplicacionWeb.HistorialEjecucionActividadesR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="<%= Page.ResolveUrl("~/Scripts/HistorialEjecucionAR.js") %>" type="text/javascript"></script>
...
<div id="ContenidoPagina" ClientIDMode="Static" runat="server">
    <div id="toolbar-box">
        <div class="submenu-box">
            ...
            <div class="pagetitle icon-32-progra-act">
                <h2>Historial de Ejecución de Actividades</h2>
            </div>
            <div class="clr"></div>
        </div>
        <!--fin class m-->
    ...
    <div id="element-box">
        <div class="m margintop10">
            <div class="floatIzq">
             De    
            <input type="text" id="FechaInicio" ClientIDMode="Static" runat="server" value="" class="textbox" style="width:100px;"/>
             hasta 
            <input type="text" id="FechaFin" ClientIDMode="Static" runat="server" value="" class="textbox" style="width:100px;"/>
            <input type="button" value="Consultar" title="Consultar Actividades Ejecutadas entre las fechas seleccionadas" id="Consultar"/>          
            <h2 id="TituloTabla" ClientIDMode="Static" runat="server"></h2>
            </div>
            <div class="floatDer">
