	...
	$.jstree.plugin("crrm", { 
		...
		_fn : {
				...
				var rtl = this._get_settings().core.rtl,
					...
					$("<input />", { 
						...
						"css" : {
                            ...
                            "text-transform": "uppercase"//Modificacion
						},
						"blur" : $.proxy(function () {
			...
			rename : function (obj) {
                ...
                //Modificacion
					f.call(this, { "obj" : obj, "new_name" : new_name.toUpperCase(), "old_name" : old_name });
				});
			},
				...
				t = this.create_node(obj, position, js, function (t) {
					...
					if(!skip_rename) { 
						this._show_input(t, function (obj, new_name, old_name) { 
							_this.__callback({ "obj" : obj, "name" : new_name.toUpperCase(), "parent" : p, "position" : pos });
						});
					}
					else { _this.__callback({ "obj" : t, "name" : this.get_text(t).toUpperCase(), "parent" : p, "position" : pos }); }
				});
				return t;
			},
			remove : function (obj) {
