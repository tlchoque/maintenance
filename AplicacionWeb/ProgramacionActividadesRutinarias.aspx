<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="ProgramacionActividadesRutinarias.aspx.cs" Inherits="Mantenimiento.AplicacionWeb.ProgramacionActividades" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="<%= Page.ResolveUrl("~/Scripts/ProgramacionActividadesR.js") %>" type="text/javascript"></script>
    ...
    <div id="toolbar-box">
        <div class="submenu-box">
            <div class="toolbar-list">
                <ul>
                    <li><a  href="#" title="Programar Actividades" id="ProgramarActividades"><span class="icon-16-programar-act"></span>Programar</a></li>
                    <li class="divider"></li>
            ...
            <div class="pagetitle icon-32-progra-act">
                <h2>Programación de Actividades - Actividades Iniciadas</h2>
            </div>
            <div class="clr"></div>
        </div>
        <!--fin class m-->
            ...
            <table class="stabla " id="listRegistros" width="100%">
                <thead>
                    <tr >
                        ...
                        <th width="2%"></th>
                        <th width="40%" >
                            Actividades Rutinarias Programables
                        </th>
                        <th width="15%">
                        ...
                        <th width="15%">
                            Mantenimiento Programado Tentativo
                            <a href="#" title="Guardar Fechas" class="Guardar" id="guardarFechasNext"></a>                           
                        </th>
                        <th width="5%">
                            Días de Retrazo
                        </th>
